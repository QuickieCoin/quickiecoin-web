<template>
  <main>
    <div class="terms-and-conditions-container">
      ...
      <h2>Blockchain</h2>
      <p>
        Once a transaction is confirmed on the Bitcoin Blockchain we are no longer able to provide support.
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to QuickieCoin NJ LLC, 301 Route 17 North Suite 800 #12-40
      ...
      <ul>
        <li>By email: team@quickiecoin.com</li>
      </ul>
    </div>
  </main>
</template>
